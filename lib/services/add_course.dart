                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration:
                            textInputdecoration(context, "addc.postd".tr()).copyWith(
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration: textInputdecoration(context, "ccd.description".tr())
                            .copyWith(
                          prefixIcon: Icon(Icons.description),
                        ),
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'addc.descriptionMessage'.tr();
                          }
                          return null;
                        },
                      ),
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration:
                            textInputdecoration(context, "ccd.price".tr()).copyWith(
                          prefixIcon: Icon(Icons.attach_money),
                        ),
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'addc.priceMessage'.tr();
                          }
                          return null;
                        },
                      ),
                    ...
                    SizedBox(
                      ...
                      child: InputDecorator(
                        decoration:
                            textInputdecoration(context, "addc.category".tr()).copyWith(
                          prefixIcon: Icon(Icons.category),
                        ),
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            value: categorySelctor,
                            hint: Text('addc.categoryMessage'.tr()),
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        readOnly: true,
                        decoration:
                            textInputdecoration(context, "addc.date".tr()).copyWith(
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration:
                            textInputdecoration(context, "addc.location".tr()).copyWith(
                          prefixIcon: Icon(Icons.location_pin),
                        ),
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'addc.locationMessage'.tr();
                          }
                          return null;
                        },
                      ),
