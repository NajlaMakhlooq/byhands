    ...
    if (response != null) {
      ...
      if (icon.isNotEmpty) {
        ...
        final imageUrlResponse =
            supabase.storage.from('images').getPublicUrl('categories/$icon');
        setState(() {
                ...
                children: <Widget>[
                  ...
                  Center(
                    child: Text(
                      description!,
                      style: TextStyle(
                          fontSize: 12, color: Color.fromARGB(255, 54, 43, 75)),
                    ),
                  ),
                  Divider(
                    color: Color.fromARGB(200, 54, 43, 75),
                    height: 20,
                  ),
                  details.isEmpty
                      ? Center(
                          child: Text('cd.noPost'.tr()),
                        )
                      : Expanded(
