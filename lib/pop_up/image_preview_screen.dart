                  ...
                  children: <Widget>[
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration:
                            textInputdecoration(context, "isp.name".tr()).copyWith(
                          prefixIcon: Icon(Icons.title_rounded),
                        ),
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'ips.name_error'.tr();
                          }
                          return null;
                        },
                      ),
                    ...
                    SizedBox(
                      ...
                      child: InputDecorator(
                        decoration:
                            textInputdecoration(context, "isp.category".tr()).copyWith(
                          prefixIcon: Icon(Icons.category),
                        ),
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            value: categorySelctor,
                            hint: Text('isp.categoryd'.tr()),
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration:
                            textInputdecoration(context, "isp.content".tr()).copyWith(
