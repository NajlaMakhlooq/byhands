        ...
        return AlertDialog(
          ...
          content: Form(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  _buildTextField(nameController, "categories.name".tr(),
                      "categories.nameValidation".tr()),
                  SizedBox(height: 15),
                  _buildTextField(descrbtionController, "categories.description".tr(),
                      "categories.descriptionValidation".tr()),
                  SizedBox(height: 15),
                  _buildTextField(explainController, "categories.explanation".tr(),
                      "categories.explanationValidation".tr()),
                  SizedBox(height: 15),
                ],
              ),
            ),
          ...
          actions: [
            ...
            TextButton(
              ...
              onPressed: () async {
                bool categoryExists = await checkCategorynameExists(nameController.text);
                if (categoryExists) {
                  Navigator.of(context).pop();
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      backgroundColor: Theme.of(context).scaffoldBackgroundColor,
                      content: Text('categories.exists'.tr()),
                    ),
                  );
                  return;
                }
      ...
      body: Column(
        children: [
            ...
            child: Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'categories.searchLabel'.tr(),
          ...
          TextButton(
            ...
            child: Text("categories.requestButton".tr(),
