...
import 'package:byhands/pages/userInfo_pages/profile_pages/followerList_display.dart';
import 'package:byhands/pages/userInfo_pages/profile_pages/followingList_display.dart';
import 'package:flutter/material.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

class profileHeader extends StatefulWidget {
  profileHeader({super.key, required this.username});
  String username;
    ...
    onPressed: () {
      ...
      if (text == 'Followers') {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder:
                (context) => FollowerlistDisplay(followerList: followerList),
          ),
        );
      }
      if (text == 'Following') {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder:
                (context) => FollowinglistDisplay(followingList: followingList),
          ),
        );
      }
    },
