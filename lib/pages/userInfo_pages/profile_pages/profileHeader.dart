...
class _profileHeader extends State<profileHeader> {
  ...
  Widget NumbersWidget() => followingList.isEmpty
      ...
      : Row(
          ...
          children: [
            buildButton(text: 'header.post'.tr(), value: postList.length),
            buildButton(text: 'header.followers'.tr(), value: followerList.length),
            buildButton(text: 'header.following'.tr(), value: followingList.length),
          ],
        );
  ...
  Widget buildButton({
    ...
    required int value,
      ...
      MaterialButton(
        ...
        onPressed: () {
          if (text == 'header.post'.tr()) {}
          if (text == 'header.followers'.tr()) {
            Navigator.push(
              context,
              MaterialPageRoute(
