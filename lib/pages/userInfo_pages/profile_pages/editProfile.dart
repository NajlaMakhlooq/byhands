...
class _EditState extends State<Edit> {
  ...
  Future<void> fetchInformation() async {
    ...
    try {
      ...
      Future<void> getURL() async {
        ...
        final response = supabase.storage.from('images').getPublicUrl(
  ...
  Future<void> upDateData() async {
    try {
      ...
      // If no error, proceed with success message
                    ...
                    Form(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          SizedBox(height: 12),
                          // Bio TextField
                          buildTextFormField(_BioController, 'Bio', Icons.note),
                          SizedBox(height: 12),
                          // Gender Dropdown
                          buildGenderDropdown(),
                          SizedBox(height: 12),
  ...
  Widget buildTextFormField(
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: textInputdecoration(context, label).copyWith(
  ...
  Widget buildGenderDropdown() {
    return SizedBox(
      ...
      child: InputDecorator(
        decoration: textInputdecoration(context, "Gender").copyWith(
  ...
  Widget buildDateOfBirthPicker() {
    return SizedBox(
      ...
      child: TextFormField(
        ...
        readOnly: true,
        decoration: textInputdecoration(context, dateOfBirth).copyWith(
